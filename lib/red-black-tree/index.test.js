...
test('creating the first node', t => {
  // B
  const tree = new RedBlackTree<string>(5, 'five')
...
test('changing the value of an existing node', t => {
  // B
  const tree = new RedBlackTree<string>(5, 'five').set(5, 'FIVE')
  t.deepEqual([...tree], [tree])
  t.is(tree.key, 5)
...
test('adding a second node to the left', t => {
  ...
  //  /
  // R
  const tree = new RedBlackTree<string>(5, 'five').set(3, 'three')
...
test('adding a second node to the right', t => {
  ...
  //  \
  //   R
  const tree = new RedBlackTree<string>(5, 'five').set(7, 'seven')
...
test('adding a third node at depth 3 (left then left, left)', t => {
  ...
  //  /
  // R
  const tree = new RedBlackTree<string>(5, 'five').set(3, 'three').set(1, 'one')
  t.deepEqual([...tree], [tree.left, tree, tree.right])
  t.is(tree.key, 3)
  t.is(tree.color, 'black')
...
test('adding a third node at depth 3 (right then right, left)', t => {
  ...
  //  /          \
  // R            R
  const tree = new RedBlackTree<string>(5, 'five').set(7, 'seven').set(6, 'six')
  t.deepEqual([...tree], [tree.left, tree, tree.right])
  t.is(tree.key, 6)
  t.is(tree.color, 'black')
...
test('adding a fifth node (left, left then left, right)', t => {
  ...
  //  / \          / \
  // R   R        B   B
  const tree = new RedBlackTree<string>(7, 'seven')
    .set(5, 'five')
    .set(9, 'nine')
    .set(4, 'four')
    .set(6, 'six')
...
test('deleting a root having only a left child', t => {
  ...
  //  /   =>
  // R
  const tree = new RedBlackTree<string>(7, 'seven').set(5, 'nine').delete(7)
...
test('deleting a root having only a right child', t => {
  ...
  //  \   =>
  //   R
  const tree = new RedBlackTree<string>(7, 'seven').set(9, 'nine').delete(7)
...
test('deleting the second node (left)', t => {
  ...
  //  /   =>
  // R
  const tree = new RedBlackTree<string>(7, 'seven').set(5, 'five').delete(5)
...
test('deleting the second node (right)', t => {
  ...
  //  \   =>
  //   R
  const tree = new RedBlackTree<string>(7, 'seven').set(9, 'nine').delete(9)
